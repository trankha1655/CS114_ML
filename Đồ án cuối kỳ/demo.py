...
class Window(QWidget):
    def __init__(self, cams: Dict[int,str]) ->None:
        ...
        model1= enet_get_model("Source\Model\SS\ckpt-enet_midcam_0.46.pth","cuda:0")
        model2 = enet_get_model("Source\Model\SS\ckpt-enet_2cam_0.67.pth","cuda:0")

        self.pred_model= load_model("Source\Model\Classify\Model_MobileNet_0.77.h5",compile=False)
...
if __name__ == "__main__":
    ...
    cams[1] = "storage/demo_cam1.mp4"
    cams[2] = "storage/demo_cam2.mp4"
    cams[3] = "storage/demo_cam3.mp4"
